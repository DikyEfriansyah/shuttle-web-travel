...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url() . "assets/" ?>css/materialert.css">
...
<body>
  <header>
    <nav class="nav-material grey lighten-5">
      <div class="nav-wrapper">
        <a style="padding-left: 0px;padding-top: 0px;" href="<?= site_url() ?>" class="brand-logo">
          <img  class="img-brand responsive-img" src="<?= base_url() . "assets/" ?>images/imgonline-com-ua-resize-p2YZwIeqJFTQV-removebg-preview.png">
        </a>
      ...
      <li><a class="light" href="collapsible.html">Tiket Keret Api</a>
          ...
          <li>
            ...
            ?>
              <a class='light dropdown-button btn teal darken-4' href='#' data-activates='dropdown1'>
            ...
            ?>
              ...
              <ul id='dropdown1' class='dropdown-content'>
                <li><a class="teal-text text-darken-4" href="<?= site_url('account/register') ?>"><i class="material-icons">person_add</i> Daftar</a></li>
                <li><a class="teal-text text-darken-4" href="<?= site_url('account/login') ?>"><i class="material-icons">persons</i> Masuk</a></li>
              </ul>
            <?php
            } ?>
          </li>
  ...
  <footer class="page-footer teal darken-3">
    <div class="container">
      <div class="row">
        <div class="col l4 s12">
          <h5 class="white-text">
            <img class="responsive-img ml-4" src="<?= base_url('assets/images/syutel-line.png') ?>">
          </h5>
          <p class="grey-text text-lighten-4">
            All in One Pemesanan Tiket Moda Transportasi</p>
        </div>
    ...
    <div class="footer-copyright teal darken-3">
      <div class="container">
        <span>Copyright &copy; 2021 <a class="grey-text text-lighten-4" href="<?= base_url() ?>" target="_blank">Shuttle</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="<?= base_url() ?>">Kelompok 1 PWEB II</a></span>
      </div>
    </div>
  </footer>
    ...
    $("#register").click(function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          $("input").removeAttr("disabled", "disabled");
          if (data.result) {
            $('#message').append('<div class="alert green">' + data.content + '</div>');
