<main>
 <div class="carousel carousel-slider center" data-indicators="true">
  ...
  <div style="text-align: left" class="carousel-item teal darken-1 white-text" href="#one!">
    <div class="container">
    <?php 
    if($this->session->userdata('auth_user')){
      ...
      <p class="white-text">Nikmati berbagai kemudahan dalam membeli tiket hanya di Shuttle.com</p>
      <?php
    }else{
      ?>
      <h3 style="margin-top: 100px" class="light">Selamat Datang di Shuttle</h3>
      <p class="white-text">All In One Pemesanan Tiket Moda Transportasi</p>
      <a href="<?=site_url('account/register')?>" class="btn waves-effect teal darken-4 white-text darken-text-2">DAFTAR SEKARANG</a>
      <?php
    }
    ?>
  </div>
            ...
            <form method="GET" action="<?=site_url('flight/search')?>">    
              ...
              <div class="row">
                ...
                <div class="col l4 m4 s12">
                  <button type="submit" style="margin-top:20px;width: 100%" class="waves-effect teal darken-4 waves-light btn"><i class="material-icons left">search</i>CARI TIKET</button>
                </div>
              </div>
            </form>
          </div>
          <div id="test2">  
            ...
            <form method="GET" action="<?=site_url('train/search')?>">    
              ...
              <div class="row">
                ...
                <div class="col l4 m4 s12"><button type="submit" style="margin-top:20px;width: 100%" class="waves-effect teal darken-3 waves-light btn"><i class="material-icons left">search</i>CARI TIKET</button>
                </div>
              </div>
            </form>
          </div>
