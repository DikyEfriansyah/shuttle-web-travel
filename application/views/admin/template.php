...
<body>
    ...
    <nav class="nav-material grey lighten-5">
      <div class="nav-wrapper">
        <a style="padding-left: 20px;padding-top: 3px" href="#!" class="hide-lg brand-logo">
          <img class="img-brand" src="<?= base_url() . "assets/" ?>images/imgonline-com-ua-resize-p2YZwIeqJFTQV-removebg-preview.png">
        </a>
        <a href="#" data-activates="mobile-demo" class="button-collapse teal darken-4-text"><i class="material-icons">menu</i></a>

        <ul class="right hide-on-med-and-down">
          <li> <a class='light dropdown-button btn teal darken-4' href='#' data-activates='dropdown1'>
        ...
        <ul class="side-nav fixed grey lighten-4" id="mobile-demo">
          <div class="side-logo hide-sm">
            <img src="<?= base_url() . "assets/" ?>images/imgonline-com-ua-resize-p2YZwIeqJFTQV-removebg-preview.png">
          </div>
          <li>
            <div class="user-view">
              <div class="background teal darken-4">
              </div>
              <a href="#!user"><img class="circle" src="<?= base_url() . "assets/" ?>images/user-white-black.png"></a>
  ...
  <footer class="page-footer">
    <div class="footer-copyright teal darken-4">
      <div class="container">
        <span>Copyright &copy; 2020 <a class="grey-text text-lighten-4" href="<?= base_url() ?>" target="_blank">Shuttle</a> All rights reserved.</span>
