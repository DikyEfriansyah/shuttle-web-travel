        ...
        <div class="card-content white">
          <div class="container">
            ...
            <?php foreach($inputType as $i){
              ...
              <?php } ?>
              <button type="submit" class="btn waves-effect waves-light teal darken-4"><i class="material-icons inline-text">save</i> Simpan</button>
              <button type="reset" class="btn waves-effect waves-light grey lighten-5 teal-text"><i class="material-icons inline-text">replay</i> Reset</button>
            </form>
            <?php }else{
              ?>
              <?php
    ...
    <div class="col m5 s12">
      <div class="card grey lighten-4">
        ...
        <div class="card-content white">
          <div class="container">
            <div class="btn-group">
              <a href="<?=site_url('admin/'.$page.'/index/add')?>" class="btn teal darken-4 waves-effect waves-light block"><i class="material-icons inline-text">add_box</i> Tambah Data</a>
              <a href="<?=site_url('admin/'.$page.'/backup')?>" class="btn teal darken-4 waves-effect waves-light block"><i class="material-icons inline-text">backup</i> Backup Database</a>
              <a href="<?=site_url('admin/'.$page.'/export')?>" class="btn teal darken-4 waves-effect waves-light block"><i class="material-icons inline-text">keyboard_backspace</i> Export CSV</a>
              <a href="#truncate" class="btn teal darken-4 waves-effect modal-trigger waves-light block"><i class="material-icons inline-text">delete_forever</i> Hapus Semua Data</a>
